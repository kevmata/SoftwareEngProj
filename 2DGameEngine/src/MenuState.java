...
public class MenuState implements State {
    ...
    public void keyPressed(KeyEvent key) {
        if (key.getKeyCode() == KeyEvent.VK_W) {
            GamePanel.setState(new GameState());
        }
        ...
        System.out.println("Key Pressed in Menu");
    }
    ...
    public void render(Graphics2D g) {
        ...
        Rectangle menuText = getStringBounds(g, "Menu State!", 250 - fontMetrics.stringWidth("Menu State!"), 100);
        ...
        g.drawString("Menu State!", 250 - fontMetrics.stringWidth("Menu State!"), 100);
        g.rotate(-rotValue, rotX, rotY);
